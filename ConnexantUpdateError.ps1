...
Set-Content -Path "C:\Temp\EnableSound.txt" -Value 'powershell.exe  -NoProfile -ExecutionPolicy Bypass -Command "& {Get-PnpDevice -FriendlyName "*Conexant*" -Class MEDIA | Enable-PnpDevice -confirm:$false}"'
